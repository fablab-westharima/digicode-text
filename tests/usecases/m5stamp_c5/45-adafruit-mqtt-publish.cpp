...
static const char* MQTT_CLIENT_ID = "stamp-c5-adafruit";
static const char* MQTT_USER = "digicode";
static const char* MQTT_PASS = "not-a-real-key";
static const char* TOPIC_STATE = "digicode/stamp-c5/state";
static const char* TOPIC_UPTIME = "digicode/stamp-c5/uptime";
static const char* TOPIC_COMMAND = "digicode/stamp-c5/command";

// 基板の青い LED（G28 は BOOT ストラップ兼用） (GPIO28)。
