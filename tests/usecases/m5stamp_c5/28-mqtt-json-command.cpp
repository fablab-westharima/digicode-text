...
static const char* TOPIC_CMD = "digicode/stamp-c5/cmd";
static const char* TOPIC_ACK = "digicode/stamp-c5/ack";
static const char* TOPIC_LWT = "digicode/stamp-c5/online";

// 汎用の GPIO0 / GPIO7 / GPIO25 と、基板の青い LED（G28 は BOOT ストラップ兼用）
// (GPIO28)。
static const uint8_t RELAY_PINS[] = { 0, 7, 25, 28 };
