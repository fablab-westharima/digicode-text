...
// この variant の A0 から A5 は GPIO1 から GPIO6。2 本目の入力レジスタも同じ A0 から埋める。
static const uint8_t ADC0_PIN = 1;   // M5StampC5: GPIO1 は A0
// COIL_LED の出力先は基板の青い LED（G28 は BOOT ストラップ兼用） (GPIO28)。
static const uint8_t OUTPUT_PIN = 28;
