...
static const char* NODE_ID = "digicode-stamp-c5";
static const char* STATE_TOPIC = "digicode/stamp-c5/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/stamp-c5/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode M5StampC5";
