...
// XIAO ESP32S3: A0=GPIO1 / A1=GPIO2 / A2=GPIO3 は ADC1 なので校正済み。
...
static Config config = { 2000, "xiao-s3-01", false, 1.0f };
...
void setup() {
  ...
  applyConfig("{\"intervalMs\":1500,\"verbose\":true,\"scale\":1.02,\"nodeId\":\"bench-s3\"}");
}
