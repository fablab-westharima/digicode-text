...
static const char* TOPIC_CMD = "digicode/xiao-s3/cmd";
static const char* TOPIC_ACK = "digicode/xiao-s3/ack";
static const char* TOPIC_LWT = "digicode/xiao-s3/online";

static const uint8_t RELAY_PINS[] = { 1, 2, 3, 4 };
