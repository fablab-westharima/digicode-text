...
static const char* NODE_ID = "digicode-xiao-s3";
static const char* STATE_TOPIC = "digicode/xiao-s3/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/xiao-s3/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode XIAO ESP32S3";
