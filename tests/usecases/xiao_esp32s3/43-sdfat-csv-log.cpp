...
// XIAO ESP32S3: SCK=GPIO7 MISO=GPIO8 MOSI=GPIO9 (D8/D9/D10) CS=GPIO4 (D3)
static const uint8_t SD_SCK = 7;
static const uint8_t SD_MISO = 8;
static const uint8_t SD_MOSI = 9;
