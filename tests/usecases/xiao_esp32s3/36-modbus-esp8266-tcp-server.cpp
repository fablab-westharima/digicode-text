...
static const uint16_t IREG_ADC1 = 1;       // A1 生値
static const uint16_t IREG_UPTIME = 2;     // 起動からの秒数
static const uint16_t COIL_LED = 0;

static const uint8_t ADC0_PIN = 1;   // XIAO ESP32S3 D0 = GPIO1 (A0)
static const uint8_t ADC1_PIN = 2;   // XIAO ESP32S3 D1 = GPIO2 (A1)
// COIL_LED の出力先は基板上のユーザー LED (GPIO21)。LOW で点灯するアクティブ LOW。
