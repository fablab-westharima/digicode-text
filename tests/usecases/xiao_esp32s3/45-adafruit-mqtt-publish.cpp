...
static const char* MQTT_CLIENT_ID = "xiao-s3-adafruit";
static const char* MQTT_USER = "digicode";
static const char* MQTT_PASS = "not-a-real-key";
static const char* TOPIC_STATE = "digicode/xiao-s3/state";
static const char* TOPIC_UPTIME = "digicode/xiao-s3/uptime";
static const char* TOPIC_COMMAND = "digicode/xiao-s3/command";

// 基板上のユーザー LED (GPIO21)。LOW で点灯するアクティブ LOW。
