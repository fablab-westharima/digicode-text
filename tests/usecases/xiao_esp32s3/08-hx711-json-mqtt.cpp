...
static const char* TOPIC_WEIGHT = "digicode/xiao-s3/weight";
static const char* TOPIC_COMMAND = "digicode/xiao-s3/weight/cmd";

static const int LOADCELL_DOUT_PIN = 1;
static const int LOADCELL_SCK_PIN = 2;
