...
static const char* NODE_ID = "digicode-stamps3a";
static const char* STATE_TOPIC = "digicode/stamps3a/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/stamps3a/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode M5StampS3A";
