...
static const uint16_t IREG_ADC0 = 0;       // GPIO1 の生値
static const uint16_t IREG_ADC1 = 1;       // GPIO2 の生値
static const uint16_t IREG_UPTIME = 2;     // 起動からの秒数
static const uint16_t COIL_LED = 0;

static const uint8_t ADC0_PIN = 1;  // M5StampS3A: GPIO1 は ADC1
static const uint8_t ADC1_PIN = 2;  // M5StampS3A: GPIO2 も ADC1
static const uint8_t OUTPUT_PIN = 5;
