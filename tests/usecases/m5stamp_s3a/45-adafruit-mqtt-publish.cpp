...
static const char* MQTT_CLIENT_ID = "stamps3a-adafruit";
static const char* MQTT_USER = "digicode";
static const char* MQTT_PASS = "not-a-real-key";
static const char* TOPIC_STATE = "digicode/stamps3a/state";
static const char* TOPIC_UPTIME = "digicode/stamps3a/uptime";
static const char* TOPIC_COMMAND = "digicode/stamps3a/command";

// このボードにユーザー LED は無いので、LED_PIN は GPIO25 に外付けした LED のつもり。
static const uint8_t LED_PIN = 5;
static const uint8_t ADC_PIN = 1;  // M5StampS3A: GPIO1 は ADC1
