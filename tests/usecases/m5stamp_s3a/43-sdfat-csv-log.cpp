...
// M5StampS3A: SCK=GPIO6 MISO=GPIO7 MOSI=GPIO8 CS=GPIO9
static const uint8_t SD_SCK = 6;
static const uint8_t SD_MISO = 7;
static const uint8_t SD_MOSI = 8;
static const uint8_t SD_CS = 9;
