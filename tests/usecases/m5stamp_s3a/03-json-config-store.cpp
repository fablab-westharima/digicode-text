...
// M5StampS3A: この variant は A0 から An のマクロを定義しないので、ADC の GPIO 番号を直接書く。
// GPIO1 / GPIO2 / GPIO3 はいずれも ADC1 (ESP32-S3 の ADC1 は GPIO1 から GPIO10)。
static const uint8_t ANALOG_INPUTS[3] = { 1, 2, 3 };
...
static Config config = { 2000, "stamps3a-01", false, 1.0f };
...
void setup() {
  ...
  applyConfig("{\"intervalMs\":1500,\"verbose\":true,\"scale\":1.02,\"nodeId\":\"bench-stamps3a\"}");
}
