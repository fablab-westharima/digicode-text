...
static const char* NODE_ID = "digicode-stickc-plus2";
static const char* STATE_TOPIC = "digicode/stickc-plus2/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/stickc-plus2/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode StickC Plus2";
