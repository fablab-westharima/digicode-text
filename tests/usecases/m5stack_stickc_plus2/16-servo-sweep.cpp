...
// StickC Plus2: ヘッダの GPIO26 と PORT の GPIO32。外に出ているのは GPIO0、GPIO26、GPIO32、GPIO33、GPIO36 (GPIO25 と同じ網) の 5 本だけ。
static const int PAN_PIN = 26;
static const int TILT_PIN = 32;
