...
static const char* TOPIC_TELEMETRY = "digicode/stickc-plus2/modbus";
static const char* TOPIC_COMMAND = "digicode/stickc-plus2/modbus/set";
...
static bool ensureMqtt() {
  ...
  String clientId = "stickc-plus2-modbus-";
