...
// StickC Plus2: この variant は A0 から An のマクロを定義しないので、ADC の GPIO 番号を直接書く。
// GPIO36 / GPIO32 / GPIO33 はいずれも ADC1。GPIO36 は入力専用で、ヘッダでは GPIO25 と同じ網。
static const uint8_t ANALOG_INPUTS[3] = { 36, 32, 33 };
...
static Config config = { 2000, "stickc-plus2-01", false, 1.0f };
...
void setup() {
  ...
  applyConfig("{\"intervalMs\":1500,\"verbose\":true,\"scale\":1.02,\"nodeId\":\"bench-stickc-plus2\"}");
}
