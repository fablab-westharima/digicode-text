...
static const uint16_t IREG_ADC0 = 0;       // GPIO36 の生値
static const uint16_t IREG_ADC1 = 1;       // GPIO32 の生値
static const uint16_t IREG_UPTIME = 2;     // 起動からの秒数
static const uint16_t COIL_LED = 0;

static const uint8_t ADC0_PIN = 36;  // StickC Plus2: GPIO36 は ADC1
static const uint8_t ADC1_PIN = 32;  // StickC Plus2: GPIO32 も ADC1
static const uint8_t OUTPUT_PIN = 26;
