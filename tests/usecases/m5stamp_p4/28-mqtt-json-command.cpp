...
static const char* TOPIC_CMD = "digicode/stamp-p4/cmd";
static const char* TOPIC_ACK = "digicode/stamp-p4/ack";
static const char* TOPIC_LWT = "digicode/stamp-p4/online";

static const uint8_t RELAY_PINS[] = { 4, 5, 6, 7 };
