...
static const char* NODE_ID = "digicode-stamp-p4";
static const char* STATE_TOPIC = "digicode/stamp-p4/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/stamp-p4/ha/status";
