...
static const uint16_t IREG_ADC0 = 0;       // GPIO16 の生値
static const uint16_t IREG_ADC1 = 1;       // GPIO17 の生値
static const uint16_t IREG_UPTIME = 2;     // 起動からの秒数
static const uint16_t COIL_LED = 0;

static const uint8_t ADC0_PIN = 16;  // Stamp-P4: GPIO16 は ADC1
static const uint8_t ADC1_PIN = 17;  // Stamp-P4: GPIO17 も ADC1
static const uint8_t OUTPUT_PIN = 4;
