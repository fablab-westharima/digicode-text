...
static const char* TOPIC_TELEMETRY = "digicode/stamp-p4/thermocouple";
static const char* TOPIC_COMMAND = "digicode/stamp-p4/thermocouple/set";

static const int8_t MAX_CLK = 1;
static const int8_t MAX_CS = 10;
static const int8_t MAX_DO = 2;
