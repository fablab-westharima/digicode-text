// @board m5stamp_p4
// @desc ESP32-P4 内蔵 TWAI (CAN) コントローラで受信する。外部ライブラリは使わない

#include <Arduino.h>
#include <driver/twai.h>

// ESP32-P4 は TWAI を 3 チャンネル持つ。GPIO14 を TX、GPIO15 を RX にして
// 外付けの CAN トランシーバ (SN65HVD230 など) へ繋ぐ前提。
static const gpio_num_t TWAI_TX_PIN = GPIO_NUM_14;
static const gpio_num_t TWAI_RX_PIN = GPIO_NUM_15;
