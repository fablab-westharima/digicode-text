...
static const char* MQTT_CLIENT_ID = "atoms3-adafruit";
static const char* MQTT_USER = "digicode";
static const char* MQTT_PASS = "not-a-real-key";
static const char* TOPIC_STATE = "digicode/atoms3/state";
static const char* TOPIC_UPTIME = "digicode/atoms3/uptime";
static const char* TOPIC_COMMAND = "digicode/atoms3/command";

// このボードにユーザー LED は無いので、LED_PIN は GPIO25 に外付けした LED のつもり。
static const uint8_t LED_PIN = 5;
static const uint8_t ADC_PIN = 8;  // ATOMS3: GPIO8 は ADC1
