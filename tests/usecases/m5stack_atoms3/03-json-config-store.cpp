...
// ATOMS3: この variant は A0 から An のマクロを定義しないので、ADC の GPIO 番号を直接書く。
// GPIO5 / GPIO6 / GPIO7 はいずれも ADC1 (ESP32-S3 の ADC1 は GPIO1 から GPIO10)。
static const uint8_t ANALOG_INPUTS[3] = { 5, 6, 7 };
...
static Config config = { 2000, "atoms3-01", false, 1.0f };
...
void setup() {
  ...
  applyConfig("{\"intervalMs\":1500,\"verbose\":true,\"scale\":1.02,\"nodeId\":\"bench-atoms3\"}");
}
