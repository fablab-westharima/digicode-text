...
static const uint16_t IREG_ADC0 = 0;       // GPIO5 の生値
static const uint16_t IREG_ADC1 = 1;       // GPIO6 の生値
static const uint16_t IREG_UPTIME = 2;     // 起動からの秒数
static const uint16_t COIL_LED = 0;

static const uint8_t ADC0_PIN = 5;  // ATOMS3: GPIO5 は ADC1
static const uint8_t ADC1_PIN = 6;  // ATOMS3: GPIO6 も ADC1
