...
// @desc MAX31855 の熱電対温度を JSON にして MQTT へ publish し、しきい値をコマンドで更新
...
static const char* TOPIC_TELEMETRY = "digicode/wio-node/thermocouple";
static const char* TOPIC_COMMAND = "digicode/wio-node/thermocouple/set";
