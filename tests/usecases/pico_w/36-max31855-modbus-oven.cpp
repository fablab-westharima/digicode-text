...
static const uint8_t RS485_TX = 0;  // GP0 (UART0 TX)
static const uint8_t RS485_RX = 1;  // GP1 (UART0 RX)
...
void setup() {
  ...
  // arduino-pico (earlephilhower) コアでは begin の前なら UART の pin を差し替えられる。
