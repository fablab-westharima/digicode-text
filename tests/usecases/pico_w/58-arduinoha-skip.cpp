...
// HAMqtt(Client&, HADevice&) は Client 実装を受け取る。Pico W では CYW43439 の
// WiFiClient をそのまま渡せる (RP2040 単体の Pico に TCP が無かったのとは違う)。
...
void setup() {
  ...
  device.setName("DigiCode Raspberry Pi Pico W");
