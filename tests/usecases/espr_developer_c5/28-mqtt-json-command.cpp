...
static const char* TOPIC_CMD = "digicode/espr-c5/cmd";
static const char* TOPIC_ACK = "digicode/espr-c5/ack";
static const char* TOPIC_LWT = "digicode/espr-c5/online";

// 汎用の GPIO0 / GPIO7 / GPIO25 と、基板の青い LED
// (GPIO27)。
static const uint8_t RELAY_PINS[] = { 0, 7, 25, 27 };
