...
static const char* NODE_ID = "digicode-espr-c5";
static const char* STATE_TOPIC = "digicode/espr-c5/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/espr-c5/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode ESPr Developer C5";
