...
static const char* TOPIC_CMD = "digicode/c5-devkitc/cmd";
static const char* TOPIC_ACK = "digicode/c5-devkitc/ack";
static const char* TOPIC_LWT = "digicode/c5-devkitc/online";

// 汎用の GPIO0 / GPIO7 / GPIO25 と、汎用ピン
// (GPIO23)。
static const uint8_t RELAY_PINS[] = { 0, 7, 25, 23 };
