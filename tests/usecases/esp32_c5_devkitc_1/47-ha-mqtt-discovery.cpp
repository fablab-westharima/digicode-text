...
static const char* NODE_ID = "digicode-c5-devkitc";
static const char* STATE_TOPIC = "digicode/c5-devkitc/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/c5-devkitc/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode ESP32-C5-DevKitC-1";
