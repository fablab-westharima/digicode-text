...
static const char* TOPIC_TELEMETRY = "digicode/c5-devkitc/modbus";
static const char* TOPIC_COMMAND = "digicode/c5-devkitc/modbus/set";
...
static bool ensureMqtt() {
  ...
  String clientId = "c5-devkitc-modbus-";
