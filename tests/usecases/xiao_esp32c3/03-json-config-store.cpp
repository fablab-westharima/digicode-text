...
// XIAO ESP32C3: A0=GPIO2 / A1=GPIO3 / A2=GPIO4 は ADC1 なので校正済み。
...
static Config config = { 2000, "xiao-c3-01", false, 1.0f };
...
void setup() {
  ...
  applyConfig("{\"intervalMs\":1500,\"verbose\":true,\"scale\":1.02,\"nodeId\":\"bench-c3\"}");
}
