...
static const char* NODE_ID = "digicode-xiao-c3";
static const char* STATE_TOPIC = "digicode/xiao-c3/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/xiao-c3/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode XIAO ESP32C3";
