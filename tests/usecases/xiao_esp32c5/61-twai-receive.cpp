// @board xiao_esp32c5
// @desc ESP32-C5 内蔵 TWAI (CAN) コントローラで受信する。外部ライブラリは使わない

#include <Arduino.h>
#include <driver/twai.h>

// C5 は TWAI を 1 チャンネル持つ。D1=GPIO0 を TX、D2=GPIO25 を RX にして
// 外付けの CAN トランシーバ (SN65HVD230 など) へ繋ぐ前提。
static const gpio_num_t TWAI_TX_PIN = GPIO_NUM_0;
static const gpio_num_t TWAI_RX_PIN = GPIO_NUM_25;
