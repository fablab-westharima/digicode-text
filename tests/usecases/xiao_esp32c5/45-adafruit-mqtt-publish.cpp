...
static const char* MQTT_CLIENT_ID = "xiao-c5-adafruit";
static const char* MQTT_USER = "digicode";
static const char* MQTT_PASS = "not-a-real-key";
static const char* TOPIC_STATE = "digicode/xiao-c5/state";
static const char* TOPIC_UPTIME = "digicode/xiao-c5/uptime";
static const char* TOPIC_COMMAND = "digicode/xiao-c5/command";

// 基板上のユーザー LED (GPIO27)。LOW で点灯するアクティブ LOW。
