...
static const char* TOPIC_CMD = "digicode/xiao-c5/cmd";
static const char* TOPIC_ACK = "digicode/xiao-c5/ack";
static const char* TOPIC_LWT = "digicode/xiao-c5/online";

// 側面パッドの D1=GPIO0 / D3=GPIO7 / D2=GPIO25 と、基板上のユーザー LED
// (GPIO27、LOW で点灯するアクティブ LOW)。
static const uint8_t RELAY_PINS[] = { 0, 7, 25, LED_BUILTIN };
