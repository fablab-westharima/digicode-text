...
// ESP32-DevKitC V4: この variant は A0 (GPIO36) しか定義しないので、ADC1 の GPIO 番号を直接書く。
// GPIO36 / GPIO39 / GPIO34 はいずれも入力専用で ADC1。
static const uint8_t ANALOG_INPUTS[3] = { 36, 39, 34 };
...
static Config config = { 2000, "esp32-devkitc-01", false, 1.0f };
...
void setup() {
  ...
  applyConfig("{\"intervalMs\":1500,\"verbose\":true,\"scale\":1.02,\"nodeId\":\"bench-devkitc\"}");
}
