...
static const uint16_t IREG_ADC0 = 0;       // GPIO36 (A0) の生値
static const uint16_t IREG_ADC1 = 1;       // GPIO39 の生値
static const uint16_t IREG_UPTIME = 2;     // 起動からの秒数
static const uint16_t COIL_LED = 0;

static const uint8_t ADC0_PIN = 36;  // ESP32-DevKitC V4: GPIO36 は A0。入力専用で ADC1
static const uint8_t ADC1_PIN = 39;  // ESP32-DevKitC V4: GPIO39 も入力専用で ADC1
static const uint8_t OUTPUT_PIN = 25;
