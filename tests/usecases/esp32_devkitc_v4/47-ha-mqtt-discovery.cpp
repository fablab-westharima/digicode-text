...
static const char* NODE_ID = "digicode-esp32-devkitc";
static const char* STATE_TOPIC = "digicode/esp32-devkitc/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/esp32-devkitc/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode ESP32-DevKitC V4";
