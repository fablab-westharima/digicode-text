// @board xiao_esp32c6
// @desc ESP32-C6 内蔵 TWAI (CAN) コントローラで受信する。外部ライブラリは使わない

#include <Arduino.h>
#include <driver/twai.h>

// C6 は TWAI を 2 チャンネル持つ。GPIO2 を TX、GPIO21 を RX にして
// 外付けの CAN トランシーバ (SN65HVD230 など) へ繋ぐ前提。
static const gpio_num_t TWAI_TX_PIN = GPIO_NUM_2;
static const gpio_num_t TWAI_RX_PIN = GPIO_NUM_21;
