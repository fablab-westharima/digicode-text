...
// XIAO ESP32C6: A0=GPIO0 / A1=GPIO1 / A2=GPIO2。C6 の ADC は ADC1 だけ。
static const uint8_t ANALOG_INPUTS[3] = { A0, A1, A2 };
...
static Config config = { 2000, "xiao-c6-01", false, 1.0f };
...
void setup() {
  ...
  applyConfig("{\"intervalMs\":1500,\"verbose\":true,\"scale\":1.02,\"nodeId\":\"bench-c6\"}");
}
