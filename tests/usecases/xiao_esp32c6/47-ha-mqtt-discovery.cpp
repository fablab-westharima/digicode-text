...
static const char* NODE_ID = "digicode-xiao-c6";
static const char* STATE_TOPIC = "digicode/xiao-c6/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/xiao-c6/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode XIAO ESP32C6";
