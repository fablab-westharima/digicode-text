...
// @desc ESP32-PICO-D4 内蔵 TWAI (CAN) コントローラで受信する。外部ライブラリは使わない

#include <Arduino.h>
#include <driver/twai.h>

// ESP32-PICO-D4 は TWAI を 1 チャンネル持つ。GPIO22 を TX、GPIO19 を RX にして
// 外付けの CAN トランシーバ (SN65HVD230 など) へ繋ぐ前提。
static const gpio_num_t TWAI_TX_PIN = GPIO_NUM_22;
static const gpio_num_t TWAI_RX_PIN = GPIO_NUM_19;
