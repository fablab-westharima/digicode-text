...
static const char* TOPIC_TELEMETRY = "digicode/atom-lite/modbus";
static const char* TOPIC_COMMAND = "digicode/atom-lite/modbus/set";
...
static bool ensureMqtt() {
  ...
  String clientId = "atom-lite-modbus-";
