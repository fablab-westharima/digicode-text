...
static const char* TOPIC_WEIGHT = "digicode/atom-lite/weight";
static const char* TOPIC_COMMAND = "digicode/atom-lite/weight/cmd";

static const int LOADCELL_DOUT_PIN = 33;
static const int LOADCELL_SCK_PIN = 25;
