...
static const char* NODE_ID = "digicode-atom-lite";
static const char* STATE_TOPIC = "digicode/atom-lite/ha/state";
static const char* AVAILABILITY_TOPIC = "digicode/atom-lite/ha/status";
...
static void addDevice(JsonDocument& doc) {
  ...
  ids.add(NODE_ID);
  device["name"] = "DigiCode ATOM Lite";
