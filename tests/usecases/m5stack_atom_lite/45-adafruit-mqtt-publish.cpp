...
static const char* MQTT_CLIENT_ID = "atom-lite-adafruit";
static const char* MQTT_USER = "digicode";
static const char* MQTT_PASS = "not-a-real-key";
static const char* TOPIC_STATE = "digicode/atom-lite/state";
static const char* TOPIC_UPTIME = "digicode/atom-lite/uptime";
static const char* TOPIC_COMMAND = "digicode/atom-lite/command";

// このボードにユーザー LED は無いので、LED_PIN は GPIO25 に外付けした LED のつもり。
static const uint8_t LED_PIN = 19;
static const uint8_t ADC_PIN = 32;  // ATOM Lite: GPIO32 は ADC1
