...
static const char* TOPIC_TELEMETRY = "digicode/cores3/thermocouple";
static const char* TOPIC_COMMAND = "digicode/cores3/thermocouple/set";

static const int8_t MAX_CLK = 5;
static const int8_t MAX_CS = 8;
