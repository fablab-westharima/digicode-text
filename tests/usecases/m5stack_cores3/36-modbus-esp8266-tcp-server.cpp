...
static const uint16_t IREG_ADC0 = 0;       // GPIO10 の生値
static const uint16_t IREG_ADC1 = 1;       // GPIO9 の生値
static const uint16_t IREG_UPTIME = 2;     // 起動からの秒数
static const uint16_t COIL_LED = 0;

static const uint8_t ADC0_PIN = 10;  // CoreS3: GPIO10 は ADC1
static const uint8_t ADC1_PIN = 9;  // CoreS3: GPIO9 も ADC1
