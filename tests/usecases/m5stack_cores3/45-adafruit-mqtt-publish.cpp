...
static const char* MQTT_CLIENT_ID = "cores3-adafruit";
static const char* MQTT_USER = "digicode";
static const char* MQTT_PASS = "not-a-real-key";
static const char* TOPIC_STATE = "digicode/cores3/state";
static const char* TOPIC_UPTIME = "digicode/cores3/uptime";
static const char* TOPIC_COMMAND = "digicode/cores3/command";

// このボードにユーザー LED は無いので、LED_PIN は GPIO25 に外付けした LED のつもり。
static const uint8_t LED_PIN = 5;
static const uint8_t ADC_PIN = 10;  // CoreS3: GPIO10 は ADC1
