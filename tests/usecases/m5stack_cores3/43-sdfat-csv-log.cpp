...
// CoreS3: SCK=GPIO5 MISO=GPIO6 MOSI=GPIO7 CS=GPIO8
static const uint8_t SD_SCK = 5;
static const uint8_t SD_MISO = 6;
static const uint8_t SD_MOSI = 7;
static const uint8_t SD_CS = 8;
