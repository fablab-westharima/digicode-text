...
// @desc アドレスが衝突しない 2 つの湿度計を I2C0 と I2C1 に分け、Wire1 の pin を setSDA/setSCL で指定する
...
// I2C0 (Wire): D4=GP6 SDA / D5=GP7 SCL
static const uint8_t I2C0_SDA = 6;
static const uint8_t I2C0_SCL = 7;
// I2C1 (Wire1): D0=GP26 SDA / D1=GP27 SCL。ADC パッドだがデジタルにも使える。
static const uint8_t I2C1_SDA = 26;
static const uint8_t I2C1_SCL = 27;
