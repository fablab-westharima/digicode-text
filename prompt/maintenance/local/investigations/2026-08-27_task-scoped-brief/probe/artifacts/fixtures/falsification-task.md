...
DIRTY: yes
GENERATED_AT_UTC: 2026-08-26T18:44:23.924303+00:00
GEN: S008-close
...
ROUTE: FULL_BRIEF
ROUTE_REASON: unresolved objective: no deterministic domain match
...
### B-46 — owner `prompt/maintenance/local/handover/batons.md`
🟡 **半導体ベンダ側の AI 開発支援カテゴリを本調査は一度も探していない。** 確認済みの一例は **Microchip MPLAB AI Coding Assistant**(無料 · ベンダ固有の製品/文書知識 · 継続更新 · コード編集/エラー検出)。browser ではないため連言は満たさないが、**「ベンダ知識 + AI + toolchain」という直接隣接カテゴリである。**国内ベンダ/商社側も未探索 | OPEN | 競合母集団を再構成するとき | User (opens) / Harness (measures) | 🟡
...
### B-49 — owner `prompt/maintenance/local/handover/batons.md`
🟡 **競合の absence claim を、飽和していない母集団から市場全体へ一般化しない。** 正しい単位は **「本調査で一次確認した集合では」**。S007 では「6/6 ベンダが verified matrix を公開していない」を市場全体へ外挿し、**Particle という反例で崩れた**。case **DT-6** | OPEN | 競合について「存在しない」「唯一」と書きそうになるたびに | Harness | 🟡
...
## L2 LANE_OVERLAY
LANE: FALSIFICATION
OVERLAY_IDS: B-19,B-40,B-54,S3-31,S3-38,S3-39
...
- B-17 [INLINE] The user's external planning documents have enumerated wording/factual/product-definition corrections. — owner: `prompt/maintenance/local/handover/batons.md`
...
- B-41 [INLINE] Competitor literature is not real use, which remains 0 products; read baton 41 before competitive claims. — owner: `prompt/maintenance/local/handover/batons.md`
...
- B-44 [INLINE] Competitor accounts, payment, sales contact, and personal-information entry require named Human GO; run no real-use test without it; read baton 44. — owner: `prompt/maintenance/local/handover/batons.md`
...
- B-46 [INLINE] Semiconductor-vendor AI tooling and domestic vendors were not searched; make no market-wide coverage claim; read baton 46. — owner: `prompt/maintenance/local/handover/batons.md`
...
- B-49 [INLINE] Scope competitor absence/uniqueness to the primary-checked set, never the whole market; read baton 49. — owner: `prompt/maintenance/local/handover/batons.md`
